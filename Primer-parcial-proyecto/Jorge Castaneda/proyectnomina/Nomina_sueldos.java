...
public class Nomina_sueldos {
    ...
    public void ModificarDatos(float NominaAModificar[][], String nombre[], String puesto[]){
        ...
        if(cantaux > 0){
            ...
            do{
                PersonaAModificar = JOptionPane.showInputDialog("DIGITE EL NOMBRE DE LA PERSONA. -");
                if(BuscarRegistro(PersonaAModificar) == false){
                    JOptionPane.showMessageDialog(null,"EL EMPLEADO NO EXISTE, DIGITE DE NUEVO EL NOMBRE");
                }
    ...
    public void EliminarDatos(float RegistroAEliminar[][], String nombre[], String puesto[]){
      ...
      String[]NombresEliminar = new String[cant];
        ...
        for(int i =0;i < cant;i++) {
            ...
            do{
                PersonaAEliminar = JOptionPane.showInputDialog("DIGITE EL NOMBRE DE LA PERSONA. -");
    ...
    Cantidad.println(cantaux-cant);
      ...
      /*
        ...
        for(int i= 0;i <= cant;i++) {
            ...
            for(int j = inicio; j < cantaux;j++ ) {
             if(j==cantaux-1){
                i--;
             }
                if (!(j == UbicarPersona[i] )) {
                    inicio++;
                    for (int k = inicio2; k < cantaux - cant;k++) {

                        for (int l = 0; l< 13; l++) {

                            Nomina_salarios[k][l] = RegistroAEliminar[j][l];
                            if(l == 12){
                                inicio2++;
                                k = cantaux-cant;
                            }
        ...
        for(int j = 0; j < cantaux-cant;j++) {
            ...
            for (int k = 0; k < 13; k++) {
                ...
                System.out.print(Nomina_salarios[j][k]);
...
*/
    ...
    public static void GenerarQR(String dato, String name)
    {
        ...
        try
        {
            ...
            String archivo = System.getProperty("User.home")+name+".png";
