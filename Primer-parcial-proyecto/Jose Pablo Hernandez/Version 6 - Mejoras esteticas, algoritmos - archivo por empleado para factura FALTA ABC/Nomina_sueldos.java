...
public void IngresoDatos(float Nomina_salariosArray[][], String nombre[], String puesto[]){
       ...
       try{
              ...
              for(int i = cantaux; i < cantaux+cant;i++){
               ...
               EscribirEnArchivo.println("DATOS PERSOMALES"+"\n");
         ...
         switch(op){
          ...
          case 1:
            try{
               ...
               String NombreAuxiliar = JOptionPane.showInputDialog("DIGITE EL NOMBRE DE LA PERSONA");
             ...
             while((BfRead = Buffer.readLine()) != null){
                  ...
                  if(temp.equals(NombreAuxiliar)){
                   ...
                   NombreAuxiliar = JOptionPane.showInputDialog("DIGITE EL NUEVO NOMBRE DE LA PERSONA: "+BfRead);
                   Esc.print(NombreAuxiliar);
