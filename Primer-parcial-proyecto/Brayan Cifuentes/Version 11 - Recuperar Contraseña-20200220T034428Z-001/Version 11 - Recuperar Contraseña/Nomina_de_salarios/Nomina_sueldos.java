...
public class Nomina_sueldos {
      ...
      String PersonaAEliminar ="";
        ...
        for(int i =0;i < cant;i++) {
            do{
                ...
                PersonaAEliminar = (String) JOptionPane.showInputDialog(null,"DIGITE EL NOMBRE DE LA PERSONA A ELIMNAR", "BAJAS", JOptionPane.INFORMATION_MESSAGE,Eliminar, null,"");
    ...
    public void BorraImagen(String NombreImagen){
        try{
            File Imagen = new File("null"+NombreImagen+".png");
            Imagen.delete();
        }catch(Exception err){
...

    {
        ...
        try
        {
            ...
            String archivo = System.getProperty(" ")+name+".png";
